...
ActiveRecord::Schema[8.0].define(version: 2025_10_16_185144) do
  ...
  create_table "movies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["movie_night_id"], name: "index_movies_on_movie_night_id"
  end
  ...
  create_table "recommendations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["movie_night_id"], name: "index_recommendations_on_movie_night_id"
  end
  ...
  add_foreign_key "movies", "movie_nights"
  add_foreign_key "recommendations", "movie_nights"
